...
source "/Users/$USER/dotfiles/.specialrc"
...
if [[ $USER == "charlesbedell" || $USER == "ccb" ]]; then USERDISPLAY="cb"; else USERDISPLAY="$USER"; fi
...
PATH="$DOTNET_TOOLS:$DOTNET_ROOT:/opt/homebrew/bin/:/opt/homebrew/bin:/opt/homebrew/sbin:/usr/local/sbin:$PATH"