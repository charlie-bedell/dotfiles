...
export ZSH="/Users/charlesbedell/.oh-my-zsh"
...
if [[ $USER == "charlesbedell" ]]; then USERDISPLAY="cb"; else USERDISPLAY="$USER"; fi
...
export PATH="/usr/local/opt/postgresql@16/bin:/Users/charlesbedell/.nvm/versions/node/v20.10.0/bin:/usr/local/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin:/Users/charlesbedell/.cargo/bin"
